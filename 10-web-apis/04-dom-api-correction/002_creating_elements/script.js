...
//     *   Create a `ul` element with the class `nav-list`. Inside the `ul`,
// create four `li` elements with the class `nav-item`, each containing an `a`
const navList = document.createElement('ul');
navList.className = 'nav-list';
nav.appendChild(navList);

//  element with text "Home", "Menu", "About", and "Contact".
