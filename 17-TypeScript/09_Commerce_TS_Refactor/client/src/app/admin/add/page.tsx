...
export default function AddProduct() {
  ...
  // actionState is typed as ActionState
  // TypeScript knows: error is string | null, success is boolean, message is string | undefined
  // addProduct's return type is Promise<ActionState> and TS figured it out automatically.
